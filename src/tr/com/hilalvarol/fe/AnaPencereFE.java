...
public class AnaPencereFE extends JFrame implements FeInterfaces {
	...
	public void initPencere() {
		...
		add(panel);
		setJMenuBar(bar);
		setTitle("Depo Yönetim Otomasyonu"); // baþlýk
		setSize(800,600);
		setVisible(true); // pencerenin açýlýp görülmesini saðlar
		setLocationRelativeTo(null); //pencerenin konumunun ortada olmasýný belirttik
	...
	public JTabbedPane initTabs() {
		...
		Object [] stokKolonlar = {"Id","Ürün Adý","Personel Adý","Adet","Tarih","Toplam"};
		...
		stokEkleButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				JOptionPane.showMessageDialog(null, uEntity.getAdi()+ " adlý ürün eklenmiþtir.");
		...
		Object [] satisKolonlar = {"Id","Personel Adý","Ürün Adý","Adet","Tarih"};
		...
		satisEkleButton.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				JOptionPane.showMessageDialog(null, "Satýþ baþarýlý bir þekilde gerçekleþtirildi.\n" + uEntity.getAdi() + " adlý üründen " + entity.getAdet() +" adet satýþ yapýlmýþtýr. ");
		...
		pane.addTab("Satýþlar ", icon2 , satisPanel , "Satýþlar");
